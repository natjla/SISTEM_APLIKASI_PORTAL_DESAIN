                                ...
                                <?php foreach ($item as $data) { ?>
                                    <tr>
                                        ...
                                        <td class="text-end text-primary">
                                            <a href="<?php echo base_url('/be_desain_data&bagan=' . $data['kunci']) ?>">
                                                <button type="button" class="btn btn-primary">
                                            ...
                                            <a href="<?php echo base_url('/be_edit_desain&id=' . $data['id']) ?>">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <div class="btn-inline">
                        ...
                        <a href="<?php echo base_url('/be_hapus_desain&id=' . $data['id']) ?>" class="btn btn-text-primary">
                            IYA
                        </a>
                    </div>
                </div>
...
<div class="modal fade" id="tambahdata">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?php echo base_url('/be_proses_tambah_desain') ?>" method="POST" enctype="multipart/form-data">
                <div class="modal-body">
